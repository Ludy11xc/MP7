      ...
      public void behavior() {
  		...
  		if (n.equals("1")) {
  	  	      ...
  	  	      if (luck >= 0.67) {
  	  	    	  ...
  	  	    	  System.out.println("Monster believes that what you said is just garbage and get annoyed.");
  	  	    	  ...
  	  	    	  if (n.equals("1")) {
  	  	    		  ...
  	  	    		  if (luck2 >= 0.80) {
  	  	    			  ...
  	  	    			  System.out.println("You failed to escape, but after a hard battle, killed the monster.");
  	  	    			  changeinhp = -5;
  	  	    			  this.alive2 = false;
  	  	    			  return;
  	  	    		  }
  		...
  		if (n.equals("3")) {
    		  ...
    		  System.out.println("You see the body of the monster lying on the ground.");
    		  changeinhp = 0;
    	  }
